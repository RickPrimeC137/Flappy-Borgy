...
export class VisualEffects {
  ...
  constructor(scene) {
    ...
    this._damageInProgress = false; // Flag pour empêcher les appels multiples
  }
  ...
  showDamage() {
    ...
    if (this._damageInProgress) return;
    
    this._damageInProgress = true;
    this.flash('#aa0000', 400);
    this.shake(0.01, 250);
    
    // Réinitialiser le flag après l'animation
    this.scene.time.delayedCall(500, () => {
      this._damageInProgress = false;
    });
  }
