...
class PreloadScene extends Phaser.Scene {
  ...
  init(){
    ...
    // Logo au-dessus de la vidéo pendant le chargement
    const logo = document.createElement("img");
    logo.src = "assets/LOGO_BORGY-HORIZONTAL.png";
    logo.alt = "Borgy";
    Object.assign(logo.style,{
      position:"absolute",left:"50%",top:"6%",transform:"translateX(-50%)",
      width:"78%",maxWidth:"720px",zIndex:"10000",pointerEvents:"none",
      filter:"drop-shadow(0 6px 10px rgba(0,0,0,.45))"
    });
    root.appendChild(logo); this._loadingLogoEl = logo;
  ...
  create(){
    ...
    if (this._loadingLogoEl) { this._loadingLogoEl.remove(); this._loadingLogoEl = null; }
