...
// Play
this.makeBtn(cx, H * 0.42, t("MENU_PLAY"), () => this.scene.start("game"), {
  width: bigW,
  height: bigH,
  fontSize: 40,
  bg: "#12a38a",
...
const hardBtn = this.makeBtn(cx, H * 0.52, hardLabel(), () => {
...
this.makeBtn(cx, H * 0.62, `🛒  ${t("MENU_SHOP")}`, () => this.showShop(), {
  width: bigW,
  height: bigH,
  fontSize: 32,
  bg: "#6d28d9",
...
this.makeBtn(cx, H * 0.72, `📜  ${t("MENU_QUESTS")}`, () => this.showQuests(), {
  width: bigW,
  height: bigH,
  fontSize: 32,
  bg: "#334155",
...
this.makeBtn(cx, H * 0.82, `🏆  ${t("MENU_LEADERBOARD")}`, () => {
...
const xmasSmall = this.makeBtn(leftX, baseY + 64, "🎄  XMAS", () => {
...
const langSmall = this.makeBtn(leftX, baseY + 128, (currentLang() === "fr" ? "🌐  Français" : "🌐  English"), () => {
...
this.makeBtn(rightX, baseY + 64, `⭐  ${t("MENU_VOTE").replace("🗳️ ", "")}`, () => {
...
this.makeBtn(rightX, baseY + 128, `💎  ${t("MENU_BUY")}`, () => {
